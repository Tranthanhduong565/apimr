...
var images = ['https://i.imgur.com/6gxyDgx.jpg', 'https://i.imgur.com/3mAifz1.jpg', 'https://i.imgur.com/etWAB9I.jpg', 'https://i.imgur.com/vplFgB1.jpg', 'https://i.imgur.com/BVCSxm3.jpg', 'https://i.imgur.com/PvF2gOz.jpg']
    ...
    const gamemap = {
        ...
        "hd sử dụng": `${mylink}taixiuv2?method={method}`,
        "sử dụng value": `${mylink}taixiuv2?method={method}&value={value}t`,
        "Ví dụ": `/taixiuv2?method=xiu&value=10`,
        "Test": `https://api.xlshsad.repl.co/taixiuv2?method=xiu&value=10`
    }
